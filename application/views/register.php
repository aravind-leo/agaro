	...
	<div class="form-right pull-right register-right">
		...
		<div class="form-container">
			<form action="../user/create" id="accountForm" method="POST">
				...
				<input type="hidden" id="user" name="user" value="patient"
					required="required">
				<div class="form-group">
					<input type="text" id="lName" name="lName" required="required"> <label
						for="input" class="control-label">Last Name:</label><i class="bar"></i>
				</div>
				<div class="form-group">
					<input type="date" id="dob" name="dob" required="required"> <label
						for="input" class="control-label">DOB</label><i class="bar"></i>
				</div>
				<div class="form-group">
					<select name="gender" "id="gender">
						...
						<option>Other</option>
					</select> <label class="control-label" for="select">Select Gender</label><i
						class="bar"></i>
				</div>
				<div class="form-group">
					<input type="text" id="email" name="email" required="required"> <label
						for="input" class="control-label">Email address:</label><i
						class="bar"></i>
				</div>
				<div class="form-group">
					<input type="password" id="pwd" name="pwd" required="required"> <label
						for="pwd" for="input" class="control-label">Password:</label><i
						class="bar"></i>
				</div>
				<div class="form-group">
					<input type="password" id="rpwd" name="rpwd" required="required"> <label
						for="pwd" for="input" class="control-label">Re-type Password:</label><i
						class="bar"></i>
				</div>
				<div class="form-group">
					<input type="number" id="phone" name="phone" required="required"> <label
						for="input" class="control-label">Phone Number:</label><i
						class="bar"></i>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					</select> <label class="control-label" for="select">Select City</label><i
						class="bar"></i>
				</div>
